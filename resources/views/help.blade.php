...
<head>
    ...
    <title>Pusat Bantuan - Tukang.in</title>
...
<body class="bg-gray-50 font-sans text-[#0f2d50]">
    ...
    <section class="bg-[#0f2d50] text-white py-20 relative overflow-hidden">
        ...
        <!-- Dekorasi Background sesuai style AMARTA -->
        <div class="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -mr-32 -mt-32"></div>
    </section>

    <!-- Kategori Bantuan: Replikasi Style Icon Grid -->
    <section class="py-16 container mx-auto px-6 -mt-10 relative z-20">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="bg-white p-8 rounded-[2rem] shadow-lg border border-gray-100 text-center hover:-translate-y-2 transition-all cursor-pointer">
    ...
    <section class="py-12 container mx-auto px-6 max-w-4xl">
        <h2 class="text-2xl font-bold mb-8 text-center">Pertanyaan Populer</h2>
        ...
        <div class="space-y-4" x-data="{ active: 1 }">
            ...
            <div class="bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm">
                <button @click="active = (active === 1 ? null : 1)" 
                    ...
                    <span class="font-bold">Bagaimana cara memanggil tukang di Tukang.in?</span>
                    <i class="fas fa-chevron-down text-xs transition-transform" :class="active === 1 ? 'rotate-180' : ''"></i>
                </button>
                <div x-show="active === 1" class="px-8 pb-5 text-gray-500 text-sm leading-relaxed">
            ...
            <div class="bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm">
                <button @click="active = (active === 2 ? null : 2)" 
                        class="w-full px-8 py-5 text-left flex justify-between items-center hover:bg-gray-50 transition">
                    <span class="font-bold">Apakah layanan Tukang.in memiliki garansi?</span>
                    <i class="fas fa-chevron-down text-xs transition-transform" :class="active === 2 ? 'rotate-180' : ''"></i>
                </button>
                <div x-show="active === 2" class="px-8 pb-5 text-gray-500 text-sm leading-relaxed">
                    Ya, setiap pekerjaan melalui platform AMARTA mendapatkan jaminan kualitas selama 7 hari kalender setelah pekerjaan dinyatakan selesai oleh pelanggan.
                </div>
            </div>
            ...
            <div class="bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm">
                <button @click="active = (active === 3 ? null : 3)" 
                        class="w-full px-8 py-5 text-left flex justify-between items-center hover:bg-gray-50 transition">
                    <span class="font-bold">Metode pembayaran apa saja yang tersedia?</span>
                    <i class="fas fa-chevron-down text-xs transition-transform" :class="active === 3 ? 'rotate-180' : ''"></i>
                </button>
                <div x-show="active === 3" class="px-8 pb-5 text-gray-500 text-sm leading-relaxed">
    ...
    <!-- Support CTA: Replikasi Style Card Bawah -->
    <section class="py-20 container mx-auto px-6">
        <div class="bg-gradient-to-r from-gray-800 to-black rounded-[3rem] p-12 text-white flex flex-col md:flex-row items-center justify-between shadow-2xl relative overflow-hidden">
            <div class="relative z-10 mb-8 md:mb-0 text-center md:text-left">
                ...
                <p class="opacity-70">Tim CS AMARTA siap membantu Anda 24/7 melalui jalur berikut.</p>
            </div>
            <div class="relative z-10 flex space-x-4">
                <button class="bg-[#e67e22] hover:bg-[#d35400] text-white px-8 py-3 rounded-xl font-bold transition">WhatsApp</button>
                <button class="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-8 py-3 rounded-xl font-bold border border-white/30 transition">Kirim Email</button>
            </div>
