<x-app-layout>
    <div class="container mx-auto px-6 py-12">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <!-- KOLOM KIRI (Profil, Galeri, Ulasan) -->
            <div class="lg:w-2/3 space-y-8">
                ...
                <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center md:items-start gap-8">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-400 font-medium mb-6 uppercase text-xs tracking-widest text-center md:text-left">{{ $tukang->specialty }}</p>
                        ...
                        <div class="grid grid-cols-3 gap-4 border-t pt-6 text-center">
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800">
                                    <i class="fas fa-star text-yellow-500 mr-1"></i>{{ $tukang->rating }} 
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800">{{ $tukang->total_order }}</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-8">
                            ...
                            <div class="mt-8 pt-8 border-t border-gray-50 text-center">
                                <p class="text-[10px] text-gray-400 font-bold uppercase mb-4 tracking-widest">Metode Pembayaran Tersedia</p>
